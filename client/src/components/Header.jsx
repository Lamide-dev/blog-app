            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              { isSignedIn ? (
                ...
                <Link 
                  to='/create-new-blog'  
                  type="button"
                  className="rounded-md px-3 py-2 bg-gray-800 hover:scale-95 text-white font-semibold "
                >
                    Create
                </Link>
                ...
                <div className='flex'>
                    ...
                    <Link to= '/signin' className="sm:block hidden rounded-full ml-4 border border-transparent bg-gray-100 py-2 px-7 text-sm font-medium text-yellow-600 hover:bg-gray-300 focus:outline-none">Sign up</Link>
                </div>
              )
